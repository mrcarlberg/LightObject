...
task ("help", function()
{
    ...
    colorPrint("LightObject - Framework", "bold+green");
    colorPrint("--------------------------------------------------------------------------", "bold+green");
